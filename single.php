...
if(isset($_POST) & !empty($_POST)){
	...
	if($revres){
		$smsg = "Revue soumise avec succès";
	}else{
		$fmsg = "Revue non soumise";
	}
}
			...
			<div class="container">
				<div class="row">
					<div class="page_header text-center">
						<h2>Boutique</h2>
						<p>Meilleur dans la vente de produits</p>
					</div>
						...
						<div class="align-center mb-40 mb-xs-30">
							<ul class="nav nav-tabs tpl-minimal-tabs animate">
								<li class="active col-md-6">
									<a aria-expanded="true" href="#mini-one" data-toggle="tab">Vue d'ensemble</a>
								</li>
							...
							<!--	<li class="col-md-4">
								...
								<li class="col-md-6">
									<a aria-expanded="false" href="#mini-three" data-toggle="tab">Revue</a>
								</li>
							</ul>
						</div>
						<!-- End Nav Tabs -->
