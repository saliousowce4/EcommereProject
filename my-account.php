	...
	<section id="content">
		<div class="content-blog content-account">
			...
			<table class="cart-table account-table table table-bordered">
				...
				?>
					<tr>
						...
						<td>
							<a href="view-order.php?id=<?php echo $ordr['id']; ?>">Vue</a>
							<?php if($ordr['orderstatus'] != 'Cancelled'){?>
							| <a href="cancel-order.php?id=<?php echo $ordr['id']; ?>">Retour</a>
							<?php } ?>
						</td>
					</tr>
				<?php } ?>
			...
			<div class="ma-address">
						<h3>My Addresses</h3>
						<p>Cette adresse sera utilisée pour passer la commande</p>

			<div class="row">
				<div class="col-md-6">
								<h4>adresse <a href="edit-address.php">Modifier</a></h4>
					<?php
